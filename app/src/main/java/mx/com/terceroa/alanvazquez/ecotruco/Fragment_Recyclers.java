 ...
 */
public class Fragment_Recyclers extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState ){
        ...
        database.getReference("Recyclers").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        getActivity().setTitle("Recyclers");
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_recyclers, container, false);
    }
}
